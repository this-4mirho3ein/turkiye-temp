...
const AgencyInfo: React.FC<AgencyInfoProps> = ({
  ...
  const getStatusBadge = () => {
    switch (status) {
      case 'approved':
        return <Badge color="success" variant="solid">تأیید شده</Badge>;
      case 'rejected':
        return <Badge color="danger" variant="solid">رد شده</Badge>;
      default:
        return <Badge color="warning" variant="solid">در انتظار بررسی</Badge>;
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">{ownerInfo.name}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900 dir-ltr">{ownerInfo.phone}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">{formatDate(submittedAt)}</p>
          </div>
        </div>
      </div>
    </motion.div>
